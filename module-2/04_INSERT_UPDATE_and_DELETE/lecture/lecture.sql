...
-- (It was established on 7/17/1955, has an area of 
...
SELECT * FROM park
-- Add Hawkins, IN (with a population of 30,000 and an 
-- area of 38.1 square kilometers) and Cicely, AK 
-- (with a popuation of 839 and an area of 11.4 square 
-- kilometers) to the city table.
...
SELECT * FROM city
-- Since Disneyland is in California (CA), add a record 
-- representing that to the park_state table.
...
-- Try adding a city to the city table with "XX" as the 
-- state abbreviation.
