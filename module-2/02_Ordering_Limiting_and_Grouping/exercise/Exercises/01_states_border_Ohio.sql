...
SELECT city_name + ', ' + state_abbreviation name_and_state, population FROM city WHERE state_abbreviation IN ('PA', 'WV', 'KY', 'IN', 'MI') ORDER BY state_abbreviation, city_name
